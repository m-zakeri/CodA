...
{
logFile << "travelagencyresho 1" << std::endl;

    clrscr();
    flag1='N';
    while(logFile << "travelagencyresho 2" << std::endl && (flag1!='Y'))
    {
...
logFile << "travelagencyresho 3" << std::endl;
...
{
logFile << "travelagencyshowhotel 1" << std::endl;

    int a,b;

    if(top==1)
        {
logFile << "travelagencyshowhotel 2" << std::endl;
price=(fst1*kor1*nod)+(fst2*kor2*nod);
}
    else {
logFile << "travelagencyshowhotel 3" << std::endl;
if(top==2)
        {
logFile << "travelagencyshowhotel 4" << std::endl;
price=(tst1*kor1*nod)+(tst2*kor2*nod);
}
    else {
logFile << "travelagencyshowhotel 5" << std::endl;
if(top==3)
        {
logFile << "travelagencyshowhotel 6" << std::endl;
price=(nst1*kor1*nod)+(nst2*kor2*nod);
}
logFile << "travelagencyshowhotel 7" << std::endl;

}
logFile << "travelagencyshowhotel 8" << std::endl;

}
logFile << "travelagencyshowhotel 9" << std::endl;


    if(toggle==1)
    {
logFile << "travelagencyshowhotel 10" << std::endl;

        clrscr();
        textcolor(WHITE+BLINK);
        textbackground(BLUE);
        for(int h=25; logFile << "travelagencyshowhotel 11" << std::endl && (h<50); h++)
        {
            gotoxy(20,8);
...
logFile << "travelagencyshowhotel 12" << std::endl;

        toggle=0;
    }
logFile << "travelagencyshowhotel 13" << std::endl;
...
{
logFile << "travelagencyviewhorec 1" << std::endl;


    int option;

    while(logFile << "travelagencyviewhorec 2" << std::endl && (option!=5))
    {
        clrscr();
        gotoxy(24,5);
        ...
        {
        case 1:
            logFile << "travelagencyviewhorec 3" << std::endl;
showhotelrec();
            break;
        case 2:
            logFile << "travelagencyviewhorec 4" << std::endl;
delhotelrec();
            break;
        case 3:
            logFile << "travelagencyviewhorec 5" << std::endl;
searchhotrec();
            break;
        case 4:
            logFile << "travelagencyviewhorec 6" << std::endl;
edithoteldata();
            break;
        }
logFile << "travelagencyviewhorec 7" << std::endl;

    }
logFile << "travelagencyviewhorec 8" << std::endl;
...
{
logFile << "travelagencyshowhotelrec 1" << std::endl;
    ...
    while(logFile << "travelagencyshowhotelrec 2" << std::endl && (fil1.read((char*)&user,sizeof (user))))
        {
user.showhotel();
}
logFile << "travelagencyshowhotelrec 3" << std::endl;
...
{
logFile << "travelagencydelhotelrec 1" << std::endl;
    ...
    while(logFile << "travelagencydelhotelrec 2" << std::endl && (fil2.read ((char*)&user,sizeof (user))))
    {
        if ((strcmp(name,dname))!=0)
            {
logFile << "travelagencydelhotelrec 3" << std::endl;
fil3.write((char*)&user,sizeof (user));
}
        else
            {
logFile << "travelagencydelhotelrec 4" << std::endl;
del++;
}
logFile << "travelagencydelhotelrec 5" << std::endl;

    }
logFile << "travelagencydelhotelrec 6" << std::endl;

    if(del!=0)
        {
logFile << "travelagencydelhotelrec 7" << std::endl;
cout<<endl<<"                         ...Deleted...";
}
    else
        {
logFile << "travelagencydelhotelrec 8" << std::endl;
cout<<endl<<"                       Record not found..";
}
logFile << "travelagencydelhotelrec 9" << std::endl;
...
{
logFile << "travelagencytransferhoteldata 1" << std::endl;
    ...
    while(logFile << "travelagencytransferhoteldata 2" << std::endl && (oldfile.read((char*)&user,sizeof(user))))
        {
newfile.write((char*)&user,sizeof (user));
}
logFile << "travelagencytransferhoteldata 3" << std::endl;
...
{
logFile << "travelagencysearchhotrec 1" << std::endl;
    ...
    while(logFile << "travelagencysearchhotrec 2" << std::endl && (fil4.read((char*)&user,sizeof (user))))
    {
        if(strcmp(name,sname)==0)
        {
logFile << "travelagencysearchhotrec 3" << std::endl;

            srch++;
            user.showhotel();
        }
logFile << "travelagencysearchhotrec 4" << std::endl;

    }
logFile << "travelagencysearchhotrec 5" << std::endl;

    if(srch==0)
        {
logFile << "travelagencysearchhotrec 6" << std::endl;
cout<<"                         No Record Exists";
}
logFile << "travelagencysearchhotrec 7" << std::endl;
...
{
logFile << "travelagencyedithoteldata 1" << std::endl;
    ...
    while(logFile << "travelagencyedithoteldata 2" << std::endl && (fil5.read((char*)&user,sizeof(user))))
    {
        if (strcmp (ename,name)==0)
        {
logFile << "travelagencyedithoteldata 3" << std::endl;

            resho();
            ede++;
        }
logFile << "travelagencyedithoteldata 4" << std::endl;

        fil6.write((char*)&user,sizeof (user));
    }
logFile << "travelagencyedithoteldata 5" << std::endl;

    if(ede==0)
    {
logFile << "travelagencyedithoteldata 6" << std::endl;

        gotoxy(25,17);
        cout<<"RECORD DOESNT EXIST!!!!";
    }
logFile << "travelagencyedithoteldata 7" << std::endl;
...
{
logFile << "travelagencytransferhoteldata1 1" << std::endl;
    ...
    while(logFile << "travelagencytransferhoteldata1 2" << std::endl && (oldfile2.read((char*)&user,sizeof(user))))
        {
newfile2.write((char*)&user,sizeof (user));
}
logFile << "travelagencytransferhoteldata1 3" << std::endl;
...
{
logFile << "travelagencyrestr 1" << std::endl;

    clrscr();
    flag2='N';
    while(logFile << "travelagencyrestr 2" << std::endl && (flag2!='Y'))
    {
        clrscr();
        gotoxy(20,5);
...
logFile << "travelagencyrestr 3" << std::endl;
...
{
logFile << "travelagencyshowtransport 1" << std::endl;

    if(top2==1)
        {
logFile << "travelagencyshowtransport 2" << std::endl;
price2=(atr1*not1)+(atr2*not2);
}
    else {
logFile << "travelagencyshowtransport 3" << std::endl;
if(top2==2)
        {
logFile << "travelagencyshowtransport 4" << std::endl;
price2=(ttr1*not1)+(ttr2*not2);
}
    else {
logFile << "travelagencyshowtransport 5" << std::endl;
if(top2==3)
        {
logFile << "travelagencyshowtransport 6" << std::endl;
price2=(rtr1*not1)+(rtr2*not2);
}
logFile << "travelagencyshowtransport 7" << std::endl;

}
logFile << "travelagencyshowtransport 8" << std::endl;

}
logFile << "travelagencyshowtransport 9" << std::endl;


    if(toggle==1)
    {
logFile << "travelagencyshowtransport 10" << std::endl;

        clrscr();
        for(int h=25; logFile << "travelagencyshowtransport 11" << std::endl && (h<50); h++)
        {
            gotoxy(20,8);
            cout<<"Please wait while we make the Reservation";
            gotoxy(h,10);
...
logFile << "travelagencyshowtransport 12" << std::endl;

        toggle=0;
    }
logFile << "travelagencyshowtransport 13" << std::endl;
...
{
logFile << "travelagencyviewtrrec 1" << std::endl;

    int option;
    while(logFile << "travelagencyviewtrrec 2" << std::endl && (option!=5))
    {
        clrscr();
        gotoxy(24,5);
        ...
        {
        case 1:
            logFile << "travelagencyviewtrrec 3" << std::endl;
showtransportrec();
            break;
        case 2:
            logFile << "travelagencyviewtrrec 4" << std::endl;
deltransportrec();
            break;
        case 3:
            logFile << "travelagencyviewtrrec 5" << std::endl;
searchtransportrec();
            break;
        case 4:
            logFile << "travelagencyviewtrrec 6" << std::endl;
edittransportdata();
            break;
        }
logFile << "travelagencyviewtrrec 7" << std::endl;

    }
logFile << "travelagencyviewtrrec 8" << std::endl;
...
{
logFile << "travelagencyshowtransportrec 1" << std::endl;

    fstream file1;
    file1.open("transport.dat",ios::binary|ios::in);
    while(logFile << "travelagencyshowtransportrec 2" << std::endl && (file1.read((char*)&user,sizeof (user))))
        {
user.showtransport();
}
logFile << "travelagencyshowtransportrec 3" << std::endl;
...
{
logFile << "travelagencydeltransportrec 1" << std::endl;
    ...
    while(logFile << "travelagencydeltransportrec 2" << std::endl && (file2.read ((char*)&user,sizeof (user))))
    {
        if ((strcmp(name,delname))!=0)
            {
logFile << "travelagencydeltransportrec 3" << std::endl;
file3.write((char*)&user,sizeof (user));
}
        else
            {
logFile << "travelagencydeltransportrec 4" << std::endl;
dele++;
}
logFile << "travelagencydeltransportrec 5" << std::endl;

    }
logFile << "travelagencydeltransportrec 6" << std::endl;

    if(dele!=0)
        {
logFile << "travelagencydeltransportrec 7" << std::endl;
cout<<endl<<"                    ...Deleted...";
}
    else
        {
logFile << "travelagencydeltransportrec 8" << std::endl;
cout<<endl<<"                  Record not found..";
}
logFile << "travelagencydeltransportrec 9" << std::endl;
...
{
logFile << "travelagencytransfertransportdata 1" << std::endl;

    fstream oldfile1,newfile1;
    oldfile1.open("temp3.dat",ios::binary | ios::in);
    newfile1.open("transport.dat",ios::binary | ios::out);
    while(logFile << "travelagencytransfertransportdata 2" << std::endl && (oldfile1.read((char*)&user,sizeof(user))))
        {
newfile1.write((char*)&user,sizeof (user));
}
logFile << "travelagencytransfertransportdata 3" << std::endl;
...
{
logFile << "travelagencysearchtransportrec 1" << std::endl;
    ...
    int serch=0;
    while(logFile << "travelagencysearchtransportrec 2" << std::endl && (file4.read((char*)&user,sizeof (user))))
    {
        if(strcmp(name,sename)==0)
        {
logFile << "travelagencysearchtransportrec 3" << std::endl;

            serch++;
            user.showtransport();
        }
logFile << "travelagencysearchtransportrec 4" << std::endl;

    }
logFile << "travelagencysearchtransportrec 5" << std::endl;

    if(serch==0)
        {
logFile << "travelagencysearchtransportrec 6" << std::endl;
cout<<"                       No Record Exists";
}
logFile << "travelagencysearchtransportrec 7" << std::endl;
...
{
logFile << "travelagencyedittransportdata 1" << std::endl;
    ...
    while(logFile << "travelagencyedittransportdata 2" << std::endl && (file5.read((char*)&user,sizeof(user))))
    {
        if (strcmp (edname,name)==0)
        {
logFile << "travelagencyedittransportdata 3" << std::endl;

            restr();
            ede1++;
        }
logFile << "travelagencyedittransportdata 4" << std::endl;

        file6.write((char*)&user,sizeof (user));
    }
logFile << "travelagencyedittransportdata 5" << std::endl;

    if(ede1==0)
    {
logFile << "travelagencyedittransportdata 6" << std::endl;

        gotoxy(25,17);
        cout<<"RECORD DOESNT EXIST!!!!";
    }
logFile << "travelagencyedittransportdata 7" << std::endl;
...
{
logFile << "travelagencytransfertransportdata1 1" << std::endl;

    fstream oldfile3,newfile3;
    oldfile3.open("temp2.dat",ios::binary | ios::in);
    newfile3.open("transport.dat",ios::binary | ios::out);
    while(logFile << "travelagencytransfertransportdata1 2" << std::endl && (oldfile3.read((char*)&user,sizeof(user))))
        {
newfile3.write((char*)&user,sizeof (user));
}
logFile << "travelagencytransfertransportdata1 3" << std::endl;
...
logFile << "main 1" << std::endl;
    ...
    int opt;
    while(logFile << "main 2" << std::endl && (opt!=5))
    {
...
void startup()
{
logFile << "startup 1" << std::endl;

    int a;
    for(a=50; logFile << "startup 2" << std::endl && (a>30); a--)
    {
        clrscr();
        textcolor(GREEN);
        textbackground(BLUE);
...
logFile << "startup 3" << std::endl;

    for(a=42; logFile << "startup 4" << std::endl && (a<52); a++)
    {
        gotoxy(27,18);
        cout<<"Please Wait";
        gotoxy(a,18);
...
logFile << "startup 5" << std::endl;

    clrscr();
    textcolor(GREEN );
    for(int j=0; logFile << "startup 6" << std::endl && (j<10); j++)
    {
        clrscr();
        gotoxy(j,6);
        cputs("        �������������������������");
...
int opening1()
{
logFile << "opening1 1" << std::endl;

    int pass;
    clrscr();
    for(int f=0; logFile << "opening1 2" << std::endl && (f<6); f++)
    {
        clrscr();
        textcolor(RED);
...
logFile << "opening1 3" << std::endl;

    for(f=1; logFile << "opening1 4" << std::endl && (f<13); f++)
    {
        gotoxy(3,f);
        cout<<"�";
        gotoxy(80,f);
...
logFile << "opening2 1" << std::endl;
    ...
    if (opt2!=4)
    {
logFile << "opening2 2" << std::endl;

        switch(opt2)
        {
        case 1:
            logFile << "opening2 3" << std::endl;
maketrfile();
            i++;
            break;
        case 2:
            logFile << "opening2 4" << std::endl;
makehofile();
            i++;
            break;
        case 3:
            logFile << "opening2 5" << std::endl;
maketrfile();
            i++;
            makehofile();
            i++;
...
logFile << "opening2 6" << std::endl;

    }
logFile << "opening2 7" << std::endl;
...
void places()
{
logFile << "places 1" << std::endl;

    int des;
    for(int j=0; logFile << "places 2" << std::endl && (j<20); j++)
    {
        clrscr();
        gotoxy(j+3,5);
...
logFile << "places 3" << std::endl;
    ...
    if (des!=6)
    {
logFile << "places 4" << std::endl;

        switch(des)
        {
        case 1:
            logFile << "places 5" << std::endl;
for(j=0; logFile << "places 6" << std::endl && (j<20); j++)
            {
                clrscr();
                gotoxy(j+3,5);
...
logFile << "places 7" << std::endl;

            gotoxy(45,17);
            cin>>des1;
            if(des1!=5)
                {
logFile << "places 8" << std::endl;
user.nindia(des1);
}
logFile << "places 9" << std::endl;

            break;

        case 2:
            logFile << "places 10" << std::endl;
for(j=0; logFile << "places 11" << std::endl && (j<20); j++)
            {
                clrscr();
                gotoxy(j+3,5);
                cout<<"Where do you want go......";
...
logFile << "places 12" << std::endl;

            gotoxy(45,17);
            cin>>des1;
            if(des1!=6)
                {
logFile << "places 13" << std::endl;
user.sindia(des1);
}
logFile << "places 14" << std::endl;

            break;

        case 3:
            logFile << "places 15" << std::endl;
for(j=0; logFile << "places 16" << std::endl && (j<20); j++)
            {
                clrscr();
                gotoxy(j+3,5);
                cout<<"Where do you want go......";
...
logFile << "places 17" << std::endl;

            gotoxy(45,17);
            cin>>des1;
            if(des1!=6)
                {
logFile << "places 18" << std::endl;
user.eindia(des1);
}
logFile << "places 19" << std::endl;

            break;

        case 4:
            logFile << "places 20" << std::endl;
for(j=0; logFile << "places 21" << std::endl && (j<20); j++)
            {
                clrscr();
                gotoxy(j+3,5);
                cout<<"Where do you want go......";
...
logFile << "places 22" << std::endl;

            gotoxy(45,17);
            cin>>des1;
            if(des1!=3)
                {
logFile << "places 23" << std::endl;
user.windia(des1);
}
logFile << "places 24" << std::endl;

            break;

        case 5:
            logFile << "places 25" << std::endl;
for(j=0; logFile << "places 26" << std::endl && (j<20); j++)
            {
                clrscr();
                gotoxy(j+3,5);
                cout<<"Where do you want go......";
...
logFile << "places 27" << std::endl;

            gotoxy(45,17);
            cin>>des1;
            if(des1!=3)
                {
logFile << "places 28" << std::endl;
user.cindia(des1);
}
logFile << "places 29" << std::endl;

            break;

        }
logFile << "places 30" << std::endl;

    }
logFile << "places 31" << std::endl;
...
{
logFile << "travelagencynindiaintndes 1" << std::endl;

    switch(ndes)
    {
    case 1:
        logFile << "travelagencynindiaintndes 2" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 2:
        logFile << "travelagencynindiaintndes 3" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 3:
        logFile << "travelagencynindiaintndes 4" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 4:
        logFile << "travelagencynindiaintndes 5" << std::endl;
clrscr();
        textcolor(YELLOW);
        textbackground(BLUE);
        gotoxy(25,1);
...
logFile << "travelagencynindiaintndes 6" << std::endl;
...
{
logFile << "travelagencysindiaintsdes 1" << std::endl;

    switch(sdes)
    {
    case 1:
        logFile << "travelagencysindiaintsdes 2" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 2:
        logFile << "travelagencysindiaintsdes 3" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 3:
        logFile << "travelagencysindiaintsdes 4" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 4:
        logFile << "travelagencysindiaintsdes 5" << std::endl;
clrscr();
        textcolor(RED);
    ...
    case 5:
        logFile << "travelagencysindiaintsdes 6" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
...
logFile << "travelagencysindiaintsdes 7" << std::endl;
...
{
logFile << "travelagencyeindiaintedes 1" << std::endl;

    switch(edes)
    {
    case 1:
        logFile << "travelagencyeindiaintedes 2" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 2:
        logFile << "travelagencyeindiaintedes 3" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 3:
        logFile << "travelagencyeindiaintedes 4" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 4:
        logFile << "travelagencyeindiaintedes 5" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 5:
        logFile << "travelagencyeindiaintedes 6" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
...
logFile << "travelagencyeindiaintedes 7" << std::endl;
...
{
logFile << "travelagencywindiaintwdes 1" << std::endl;

    switch(wdes)
    {
    case 1:
        logFile << "travelagencywindiaintwdes 2" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 2:
        logFile << "travelagencywindiaintwdes 3" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
...
logFile << "travelagencywindiaintwdes 4" << std::endl;
...
{
logFile << "travelagencycindiaintcdes 1" << std::endl;

    switch(cdes)
    {
    case 1:
        logFile << "travelagencycindiaintcdes 2" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
    ...
    case 2:
        logFile << "travelagencycindiaintcdes 3" << std::endl;
clrscr();
        textcolor(RED);
        textbackground(YELLOW);
        gotoxy(25,1);
...
logFile << "travelagencycindiaintcdes 4" << std::endl;
...
{
logFile << "travelagencyassignprice 1" << std::endl;
    ...
    {
    case 1:
        logFile << "travelagencyassignprice 2" << std::endl;
atr1=12000;
        atr2=9000;
        ttr1=2500;
        ttr2=2000;
        ...
        break;
    case 2:
        logFile << "travelagencyassignprice 3" << std::endl;
atr1=10000;
        atr2=8000;
        ttr1=1500;
        ttr2=1000;
        ...
        break;
    case 3:
        logFile << "travelagencyassignprice 4" << std::endl;
atr1=8000;
        atr2=6000;
        ttr1=1200;
        ttr2=1000;
        ...
        break;
    case 4:
        logFile << "travelagencyassignprice 5" << std::endl;
atr1=10000;
        atr2=8000;
        ttr1=2000;
        ttr2=1000;
        ...
        break;
    case 5:
        logFile << "travelagencyassignprice 6" << std::endl;
atr1=15000;
        atr2=12000;
        ttr1=3500;
        ttr2=2000;
        ...
        break;
    case 6:
        logFile << "travelagencyassignprice 7" << std::endl;
atr1=9000;
        atr2=7000;
        ttr1=1200;
        ttr2=1000;
        ...
        break;
    case 7:
        logFile << "travelagencyassignprice 8" << std::endl;
atr1=9000;
        atr2=7000;
        ttr1=1200;
        ttr2=1000;
        ...
        break;
    case 8:
        logFile << "travelagencyassignprice 9" << std::endl;
atr1=11000;
        atr2=9000;
        ttr1=2000;
        ttr2=1000;
        ...
        break;
    case 9:
        logFile << "travelagencyassignprice 10" << std::endl;
atr1=15000;
        atr2=12000;
        ttr1=2000;
        ttr2=1000;
        ...
        break;
    case 10:
        logFile << "travelagencyassignprice 11" << std::endl;
atr1=12000;
        atr2=9000;
        ttr1=2500;
        ttr2=2000;
        ...
        break;
    case 11:
        logFile << "travelagencyassignprice 12" << std::endl;
atr1=11000;
        atr2=9000;
        ttr1=4500;
        ttr2=2000;
        ...
        break;
    case 12:
        logFile << "travelagencyassignprice 13" << std::endl;
atr1=8000;
        atr2=6000;
        ttr1=1200;
        ttr2=1000;
        ...
        break;
    case 13:
        logFile << "travelagencyassignprice 14" << std::endl;
atr1=12000;
        atr2=10000;
        ttr1=2000;
        ttr2=1000;
        ...
        break;
    case 14:
        logFile << "travelagencyassignprice 15" << std::endl;
atr1=10000;
        atr2=8000;
        ttr1=2000;
        ttr2=1000;
        ...
        break;
    case 15:
        logFile << "travelagencyassignprice 16" << std::endl;
atr1=12000;
        atr2=9000;
        ttr1=2500;
        ttr2=2000;
        ...
        break;
    case 16:
        logFile << "travelagencyassignprice 17" << std::endl;
atr1=10000;
        atr2=8000;
        ttr1=1500;
        ttr2=1000;
        ...
        break;
    case 17:
        logFile << "travelagencyassignprice 18" << std::endl;
atr1=13000;
        atr2=10000;
        ttr1=2500;
        ttr2=2000;
        ...
        break;
    case 18:
        logFile << "travelagencyassignprice 19" << std::endl;
atr1=10000;
        atr2=8000;
        ttr1=1500;
        ttr2=1000;
...
logFile << "travelagencyassignprice 20" << std::endl;
