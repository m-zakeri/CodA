...
{
logFile << "consumergetdatavoid 1" << std::endl;
  ...
  if(met_calls<free_calls )
    {
logFile << "consumergetdatavoid 2" << std::endl;
   ...
   {
logFile << "consumergetdatavoid 3" << std::endl;

    charge_calls=met_calls-free_calls;
    met_charge=charge_calls*(.80);
   }
logFile << "consumergetdatavoid 4" << std::endl;
  ...
  {
logFile << "consumergetdatavoid 5" << std::endl;
net_amt_bef=0;
}
  else
  {
logFile << "consumergetdatavoid 6" << std::endl;
net_amt_bef=gross_amt-credits;
}
logFile << "consumergetdatavoid 7" << std::endl;

  if(credits>=gross_amt)
  {
logFile << "consumergetdatavoid 8" << std::endl;
surcharge=0;
}
  else
  {
logFile << "consumergetdatavoid 9" << std::endl;
surcharge=20;
}
logFile << "consumergetdatavoid 10" << std::endl;
...
{
logFile << "consumershowdatavoid 1" << std::endl;
...
logFile << "main 1" << std::endl;
    ...
    bar(2,1,660,660);
    setcolor(RED);
    for(i=90;logFile << "main 2" << std::endl && (i<=385);i+=17)
      {
       outtextxy(50,i,"*");
       outtextxy(560,i,"*");
      }
logFile << "main 3" << std::endl;
    ...
    for(j=50;logFile << "main 4" << std::endl && (j<=560);j+=17)
      {
       outtextxy(j,90,"*");
       outtextxy(j,385,"*");
      }
logFile << "main 5" << std::endl;
    ...
    settextstyle(1,0,4);
    for(i=220;logFile << "main 6" << std::endl && (i<221);i++)
     {
       outtextxy(280,i,"TO");
     }
logFile << "main 7" << std::endl;
    ...
    settextstyle(0,0,3);
    for(i=270;logFile << "main 8" << std::endl && (i<271);i++)
     {
...
logFile << "main 17" << std::endl;
	...
	}while(logFile << "main 17" << std::endl && (!fin.eof()));
logFile << "main 18" << std::endl;
    ...
    while (logFile << "main 18" << std::endl && ((answer=='Y')||(answer=='y')));
...
logFile << "main 22" << std::endl;
   ...
   while(logFile << "main 22" << std::endl && (!fin.eof()));
...
logFile << "main 31" << std::endl;
    ...
    while(logFile << "main 31" << std::endl && (fin));
...
logFile << "main 48" << std::endl;
  ...
  }while(logFile << "main 48" << std::endl && (fin));
logFile << "main 49" << std::endl;

 
kk:logFile << "main 50" << std::endl;
setfillstyle(1,LIGHTMAGENTA);
bar(0,0,679,679);
setfillstyle(1,LIGHTCYAN);
bar(35,200,550,250);
...
u:logFile << "main 56" << std::endl;
fin.close();
bar(0,0,680,480);
goto i;
 
y:logFile << "main 57" << std::endl;
setfillstyle(1,LIGHTMAGENTA);
bar(0,0,679,679);
...
void proj_name(void)
 {
logFile << "projnamevoid 1" << std::endl;
  ...
  for(i=170;logFile << "projnamevoid 2" << std::endl && (i<=172);i++)
  {
   sleep(1);
...
logFile << "projnamevoid 3" << std::endl;

 }
 
void created(void)
 {
logFile << "createdvoid 1" << std::endl;
